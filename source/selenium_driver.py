...
class SeleniumDriver():
    ...
    def search_body(self, empty_body_element_class_name = "pf-c-empty-state__body"):
        ...
        try:
            element_body = WebDriverWait(self.driver,5).until(EC.presence_of_element_located((By.CLASS_NAME, empty_body_element_class_name ))).text
        finally:
            return  element_body 
    ...
    def find_element_by_class_name(self):
        ...
        try:
            if   "No results" in self.driver.find_element(By.CLASS_NAME, "styles__searchHeader___28vtd").text: elements = None
            else: elements = self.driver.find_element(By.CLASS_NAME , "styles__resultsWrapper___38JCx") 
        except Exception as e:
